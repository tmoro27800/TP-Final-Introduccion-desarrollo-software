...
import PixelSnow from "../../components/Backgrounds/BackgroundMenu/BackgroundMenu.jsx";
...
export default function Menu() {
    ...
    return (
        <div className="menu-fondo-wrapper">
            {/* Fondo animado */}
            <div className="menu-fondo-pixelsnow">
                <PixelSnow
                    color="#ffffff"
                    flakeSize={0.009}
                    minFlakeSize={1.25}
            ...
            {/* Contenido del menú, por encima del fondo */}
            <div className="menu">
